document.addEventListener("DOMContentLoaded", function () {
  ...
  function calculateTotalPayment() {
    ...
    const ratePerHour = parseFloat(selectedOptions.getAttribute("data-rate"));
...
function orderRedirect(service) {
...
function submitContact(event) {
  ...
  const contactToWhatsapp = `https://wa.me/62895800188663?text=Halo%20Saya%20tertarik%20dengan%20jasa%20anda%0ANama:%20${name}%0AEmail:%20${email}%0AWhatsapp:%20${whatsapp}`;
